...
class Tic_Tac_Toe_logic:
    ...
    def find_winning_move(self, side):
        for row in range(3):
            if self.board[row][0] == self.board[row][1] == side \
                    and self.board[row][2] == BLANK:
                return (row, 2)
            elif self.board[row][0] == self.board[row][2] == side \
                    and self.board[row][1] == BLANK:
                return (row, 1)
            elif self.board[row][1] == self.board[row][2] == side \
